  ...
  return (
      <div className='flatzoom flex-colo gap-8 w-full min-h-screen text-white bg-main lg:py-20 py-10 px-6'>
        <img 
          ...
          alt='notfound'
        />
        <h1 className='text-lg text-text md:text-2xl lg:text-4xl font-bold'>Page Not Found</h1>
        <p className='font-medium text-gray-700 text-border italic leading-6'>
          The page you are looking for doest not exist. You may have mistyped the URL.
        </p>
        <Link 
          to='/'
