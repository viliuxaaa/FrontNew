...
function NavBar() {
  ...
  const hover =
    "hover:text-cyan-800 transition hover:scale-105 transitions text-text";
        ...
        <div className="container mx-auto py-6 lg:px-2 lg:grid gap-10 grid-cols-7 justify-between items-center">
          ...
          <div className="col-span-3 flex w-full">
            ...
            <button
              ...
              className="relative border border-gray-800 w-[170px] text-text bg-background rounded py-4 pl-1 text-left text-xs"
            >
            ...
            <FilterIndex catt={catt} setCatt={setCatt} />
          </div>
          {/* menus */}
