...
function SinglePosterDetailed() {
    return (
        <> 
            <div className="lg:mr-24 md:mr-20 sm:mr-12 flex flex-row justify-center xxs:w-11/12 xs:w-10/12 sm:w-9/12 md:w-8/12 lg:w-6/12 xl:w-5/12 xs:text-sm xxs:gap-1  text-text"> {/**/}
                <div className="text-end p-2 sm:text-sm xs:w-2/12 xxs:text-xs">
                    Kaunas
                    <br/>
                    Pries 1 val.
                </div>
                <div className="flex-shrink-0 pr-2"> {/*xxs:w-11/12 xs:w-6/12 sm:w-4/12 md:w-4/12 lg:w-6/12 xl:w-6/12*/}
                    <img src="https://picsum.photos/200/300" alt="Imaasdasdge" className="w-40 h-40 border-[2px] border-darkAccent shadow-md rounded-l-xl"/>
                </div>
...
export default SinglePosterDetailed
